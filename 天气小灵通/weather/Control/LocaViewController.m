...
- (NSMutableArray *)groups
{
    if (_groups == nil) {
        ...
        NSArray *dictArray = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"city" ofType:@"plist"]];
...
-(void)initTableView
{
    UITableView *tableview = [[UITableView alloc]initWithFrame:CGRectMake(0, 5, SCREEN_WIDTH,SCREEN_HEIGHT)];
...
-(void)initSearchBar
{
    ...
    self.mysearchBar.frame = CGRectMake(0,5,self.view.frame.size.width, 40);
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.edgesForExtendedLayout =UIRectEdgeNone;//防止导航栏遮挡内容
}
@end
